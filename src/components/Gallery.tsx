...
import { formatNumber, getThumbnail, getCloudInfo } from '@/types';
              ...
              >
                ...
                <div className="p-3 sm:p-3.5">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    {(() => {
                      const ci = getCloudInfo(item.link);
                      return ci.provider !== 'direct' ? (
                        <span className={cn('inline-flex items-center gap-0.5 rounded px-1.5 py-0.5 text-[8px] font-bold border shrink-0', ci.color, ci.textColor, ci.borderColor)}>
                          {ci.icon} {ci.label}
                        </span>
                      ) : null;
                    })()}
